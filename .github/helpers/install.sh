...
mysql --host 127.0.0.1 --port 3306 -u root -proot -e "CREATE USER 'test_dontmanage'@'localhost' IDENTIFIED BY 'test_dontmanage'"
mysql --host 127.0.0.1 --port 3306 -u root -proot -e "CREATE DATABASE test_dontmanage"
mysql --host 127.0.0.1 --port 3306 -u root -proot -e "GRANT ALL PRIVILEGES ON \`test_dontmanage\`.* TO 'test_dontmanage'@'localhost'"
