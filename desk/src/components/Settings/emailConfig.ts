...
import LogoDontManageMail from "@/assets/images/dontmanage-mail.svg";
...
export const customProviderFields = [
  ...fixedFields,
  {
    label: "DontManage Mail Site",
    name: "dontmanage_mail_site",
    type: "text",
    placeholder: "https://dontmanagemail.com",
  },
  {
    label: "API Key",
    name: "api_key",
...
export const services: EmailService[] = [
  ...
  {
    name: "DontManage Mail",
    icon: LogoDontManageMail,
    info: `Setting up DontManage Mail requires you to have an API key and API Secret of your email account. Read more `,
    link: "https://github.com/dontmanage/mail",
    custom: true,
  },
];
...
export const emailIcon = {
  ...
  Yahoo: LogoYahoo,
  Yandex: LogoYandex,
  "DontManage Mail": LogoDontManageMail,
};
