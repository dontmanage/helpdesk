...
type DontManageFilters = Record<string, Array<string>>;
...
export function useListFilters() {
	...
	function toDontManageFilter(f: Array<FilterItem>): DontManageFilters {
		return f.reduce((p, c) => {
	...
	function queryFilters() {
		...
		const dontmanageFilters = toDontManageFilter(filters);

		return dontmanageFilters;
	}
