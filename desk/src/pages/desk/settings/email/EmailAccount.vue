							...
							<div class="flex flex-col space-y-3">
								...
								>
									...
									<p>
										...
										<a
											href="https://docs.dontmanageerp.com/docs/v13/user/manual/en/setting-up/email/email_account_setup_with_gmail"
											target="_blank"
...
export default {
	...
	setup() {
		...
		const errors = {
			"Error: dontmanage.client.set_value InvalidEmailCredentials":
				"Invalid Email ID or Password.",
			"Error: dontmanage.client.insert ValidationError": "Validation Error.",
			"Error: dontmanage.client.insert InvalidEmailCredentials":
				"Invalid Email ID or Password.",
		}
	...
	resources: {
		checkDefaultOutgoingEmailAccount() {
			return {
				url: "dontmanage.client.get_count",
				params: {
					doctype: "Email Account",
					filters: [
						["use_imap", "=", 1],
		...
		renameEmailAccount() {
			return {
				url: "dontmanage.client.rename_doc",
				onSuccess: (data) => {
