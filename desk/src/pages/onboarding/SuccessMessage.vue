...
const github = "https://github.com/dontmanage/helpdesk";
const issues = "https://github.com/dontmanage/helpdesk/issues";
const support = "https://dontmanagedesk.com/helpdesk";
const email = "hello@dontmanage.io";
