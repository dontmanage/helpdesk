...
function handleTicketDelete(hide: Function) {
  capture("bulk_delete");
  call("dontmanage.desk.reportview.delete_items", {
...
async function exportRows(
  ...
  window.location.href = `/api/method/dontmanage.desk.reportview.export_query?file_format_type=${export_type}&title=HD Ticket&doctype=HD Ticket&fields=${fields}&filters=${filters}&order_by=${order_by}&page_length=${pageLength}&start=0&view=Report&with_comment_count=1`;
  reset();
