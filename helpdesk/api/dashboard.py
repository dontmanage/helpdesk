...
def get_ticket_count(filters=None):
	ticket_count = dontmanage.db.get_list(
		"HD Ticket",
		filters=filters,
...
def ticket_summary(startDate=None, endDate=None):
	...
	ticket_count = dontmanage.db.sql(
...
@dontmanage.whitelist()
def ticket_status():
	ticket_count_by_status = dontmanage.db.get_list(
		"HD Ticket",
...
def ticket_type(filters=None):
	ticket_count_by_type = dontmanage.db.get_list(
		"HD Ticket",
		filters=filters,
...
def average_first_response_time():
	...
	ticket_list = dontmanage.get_list(
		"HD Ticket",
...
def feedback_status(dateFilter=None):
	feedback_status_count = dontmanage.db.get_list(
		"HD Ticket",
