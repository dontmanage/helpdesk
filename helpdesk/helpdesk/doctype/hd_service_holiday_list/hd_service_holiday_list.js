...
dontmanage.ui.form.on("HD Service Holiday List", {
	...
	from_date: function (frm) {
		if (frm.doc.from_date && !frm.doc.to_date) {
			var a_year_from_start = dontmanage.datetime.add_months(
				frm.doc.from_date,
				12
			)
			frm.set_value(
				"to_date",
				dontmanage.datetime.add_days(a_year_from_start, -1)
			)
		}
	},
})

dontmanage.tour["HD Service Holiday List"] = [
	{
