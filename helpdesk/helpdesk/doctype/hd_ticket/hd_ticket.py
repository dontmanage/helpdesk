...
from dontmanage.query_builder import Case, DocType, Order
...
class HDTicket(Document):
	...
	def get_list_filters(query: Query):
		_is_agent = is_agent()
		QBTeam = dontmanage.qb.DocType("HD Team")
		QBTeamMember = dontmanage.qb.DocType("HD Team Member")
		QBTicket = dontmanage.qb.DocType("HD Ticket")
		...
		enable_restrictions, ignore_restrictions = dontmanage.get_value(
			doctype="HD Settings",
			fieldname=[
		...
		teams = (
			dontmanage.qb.from_(QBTeamMember)
	...
	def sort_options():
		def by_priority(query: Query, direction: Order):
			QBTicket = dontmanage.qb.DocType("HD Ticket")
			QBPriority = dontmanage.qb.DocType("HD Ticket Priority")
	...
	def get_assigned_agent(self):
		...
		from dontmanage.desk.form.assign_to import get
	...
	def get_assignees(self):
		QBUser = DocType("User")
		assignees = dontmanage.parse_json(self._assign)
