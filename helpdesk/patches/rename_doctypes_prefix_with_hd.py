...
doctype_map = {
	...
	"DontManage Desk Comment": "HD Ticket Comment",
	"DontManage Desk Notification": "HD Notification",
	"DontManage Desk Settings": "HD Settings",
	"Holiday": "HD Holiday",
...
def execute():
	for doctype in doctype_map:
		...
		if dontmanage.db.exists("DocType", new):
			continue

		if not dontmanage.db.exists("DocType", old):
			continue

		dontmanage.rename_doc("DocType", old, new)
