import dontmanage
from dontmanage.desk.form.assign_to import add as add_assign

AUTHOR_EMAIl = "sabu@dontmanage.io"
...
<br><br>
If you face any issues, please reach out to us via <a href="https://dontmanagedesk.com/helpdesk">
https://dontmanagedesk.com/helpdesk</a>
<br><br>
Best,
<br>
Sabu Siyad | DontManage Helpdesk.
"""
...
def create_ticket():
	if dontmanage.db.count("HD Ticket"):
		return

	d = dontmanage.new_doc("HD Ticket")
